...
def check_conformance(requirement, disagreement_log, neg_clf, super_clf, subjective_clf, vagueP_clf, ambiguousAd_clf, compPhrase_clf, loophole_clf, openEnd_clf):
    ...
    conforms_rule_1 = is_negative
    #conforms_rule_2 = is_active_voice
    conforms_rule_3 = final_super
    conforms_rule_4 = is_subjective
    conforms_rule_5 = is_vagueP
    conforms_rule_6 = is_ambiguousAd
    conforms_rule_7 = is_compPhrase
    conforms_rule_8 = is_loophole
    conforms_rule_9 = is_openEnd
    ...
    overall = conforms_rule_1 and conforms_rule_3 and conforms_rule_4 and conforms_rule_5 and conforms_rule_6 and conforms_rule_7 and conforms_rule_8 and conforms_rule_9
    ...
    return {
        ...
        "linguistic_superlative": ling_super,
        "quantifier_superlative": quant_super,
        "Negative": conforms_rule_1,
        #"ActiveVoice": conforms_rule_2,
        "Superlative": conforms_rule_3,
        "Subjective": conforms_rule_4,
        "VaguePronouns": conforms_rule_5,
        "AmbiguousAd": conforms_rule_6,
        "CompPhrase": conforms_rule_7,
        "Loopholes": conforms_rule_8,
        "OpenEnded": conforms_rule_9,
        "overall_conformance": overall,
        "negation_cues": negation_cues,
        #"passive_indicators": passive_indicators,
        "superlative_cues": superlative_cues,
